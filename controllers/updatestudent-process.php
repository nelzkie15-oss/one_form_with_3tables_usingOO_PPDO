   ...
   // session_start();
    ...
    include_once('../Initialize/class/student_collegeinfo.php');
      ...
      if(ISSET($_POST['student_id'])){
               ...
               $stud_stat->update_student($last_name, $first_name, $contact_number, $gender, $course, $teacher, $subject,  $section, $student_id);
                  echo '<script type="text/javascript">';
                  echo 'setTimeout(function () { swal("Update Student Successfully!","Message!","success");';
                  echo '}, 1000);</script>';
                  echo '<script type="text/javascript">';
